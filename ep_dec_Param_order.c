...
int main(int argc, char *argv[]){ 
  ...
  */
  ...
  while(Time[0]<totaltime){
    ...
    if(Time[0]<0.) amplitude_phi = amplitude_phi_max; //fix the amplitude at min for relaxation
    if(Time[0]>0.) amplitude_phi = amplitude_phi_max - (amplitude_phi_max-amplitude_phi_min)*Time[0]/totaltime; //fix the amplitude at min for relaxation
